...
test:
	xcodebuild -project $(PROJECT) -scheme $(SCHEME) -destination 'platform=iOS Simulator,name=iPhone 15 Pro' -derivedDataPath $(DERIVED_DATA) test CODE_SIGNING_ALLOWED=NO
